...
import com.school.community.dao.elasticsearch.DiscussPostRepository;
...
public class ElasticsearchTest {
    ...
    public void testInsert() {
        ...
        discussPosts.forEach(post -> repository.save(post));
    }
    ...
    public void testSearchByTemplate() {
        ...
        Page<DiscussPost> page = elasticTemplate.queryForPage(searchQuery, DiscussPost.class,
